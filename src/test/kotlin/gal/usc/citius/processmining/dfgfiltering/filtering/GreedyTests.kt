...
object GreedyTests : Spek({
    ...
    describe("A connected directed graph with many edges and no long cycles (only a self-cycle)") {
        ...
        context("get the minimum equivalent graph with maximum weight using the naive method") {
            val mwmfdfg = dg.filterEdgesGreedy()
        ...
        context("get the minimum equivalent graph with minimum weight using the naive method") {
            val mwmfdfg = dg.filterEdgesGreedy(true)
